%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                           Initial conditions for Gurfil GTO Example
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Orbit properties
%
hp0 = 450*1e3;                              % Initial perigee height [m]
ha0 = 451*1e3;                              % Initial apogee hegiht [m]
...
i0 = deg2rad(80);                           % Initial inclination [rad]
argp0 = deg2rad(0);                         % Initial argument of perigee [rad]
raan0 = deg2rad(0);                         % Initial RAAN [rad]
M0 = 0;                                     % Initial mean anomaly [rad]
p0 = a0*(1-e0^2);                           % Initial semilatus rectum [m]
nu0 = 0;
