...
t_naw    = (((   naw(:,1)/60)/60)/24)/365.25;
t_na0    = (((   na0(:,1)/60)/60)/24)/365.25;
...
plot(t_naw,naw(:,2)*1e-3,'r','linewidth',2);
% legendstr = {'Ward \omega = \omega_\oplus','Ward \omega = 0','Wang','Non-averaged'};
plot(t_na0,na0(:,2)*1e-3,':b','linewidth',1);
legendstr = {'Ward \omega = \omega_\oplus','Ward \omega = 0','Wang','Non-averaged \omega = \omega_\oplus','Non-averaged \omega = 0'};
if ~strcmp(noradID,'Gurfil')
...
plot(t_naw,naw(:,6),'r','linewidth',2);
% legendstr = {'Ward \omega = \omega_\oplus','Ward \omega = 0','Wang','Non-averaged'};
plot(t_na0,naw(:,6),':b','linewidth',1);
legendstr = {'Ward \omega = \omega_\oplus','Ward \omega = 0','Wang','Non-averaged \omega = \omega_\oplus','Non-averaged \omega = 0'};
if ~strcmp(noradID,'Gurfil')
...
plot(t_naw,rad2deg(naw(:,3)),'r','linewidth',2);
% legendstr = {'Ward \omega = \omega_\oplus','Ward \omega = 0','Wang','Non-averaged'};
plot(t_na0,rad2deg(naw(:,3)),':b','linewidth',1);
legendstr = {'Ward \omega = \omega_\oplus','Ward \omega = 0','Wang','Non-averaged \omega = \omega_\oplus','Non-averaged \omega = 0'};
if ~strcmp(noradID,'Gurfil')
