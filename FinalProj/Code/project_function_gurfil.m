function  [dxdt] = project_function_gurfil(t,x,mu,delta,~,~,Re,rho_p0,r_p0,avg_flag)
...
% [~,H_p] = atmosphere_gurfil(hp0*1e-3)      % Input perigee altitude in km
...
dxdt_lunisol = lunisolar(t,x,mu,delta,Re,rho_p0,r_p0,avg_flag );
