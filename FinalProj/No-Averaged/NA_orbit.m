function dx=NA_orbit(t,x,AMR,C_D,r_p0,rho_p,re,H_rho,muu,J2,Mjd_UTC)
...
[r_Earth,r_Moon,r_Sun] = JPL_Eph_DE430(MJD_TDB);
...
dx3     = rdot;
dx4     = -(muu/(norm(r)^3))*r + a_drag + a_j2 + a_LuniSolar;
dx      = [dx1;dx2;dx3;dx4];
end
