%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
function [ density ] = atmosphere_Rosengren_modified(z)
%
...
z=z/1000;    
if z>1000
    density_log = (((-33.268735553789284+32.788012546386149)/(10*1e5-9*1e5))*(z*1e3-9*1e5))-32.788012546386149;
    density     = exp(density_log);
else
